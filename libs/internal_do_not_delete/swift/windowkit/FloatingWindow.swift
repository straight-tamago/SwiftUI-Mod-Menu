...
///
/// ```swift
/// FloatingWindow(title: "Panel", isPresented: $show, persistKey: "panel_window") {
...
public struct FloatingWindow<Actions: View, Content: View>: View {
    let title: String
...
public extension FloatingWindow where Actions == EmptyView {
    init(
        title: String,
        isPresented: Binding<Bool>,
        persistKey: String? = nil,
